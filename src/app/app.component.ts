...
} from './features/weather/constants/weather.constants';
import {
  SetMyZip,
  ToggleMyUnit,
} from './features/weather/store/weather.actions';
...
} from './shared/navigation/navigation.interface';
...
export class AppComponent extends KillZombies() {
  ...
  appUnitLabel: string = WEATHER_TEMPRATURE_SYMBOLS[
  ...
  constructor(
    ...
    let unitSub = this.ngrxstore
      ...
      .subscribe((state) => {
        this.appUnitLabel = WEATHER_TEMPRATURE_SYMBOLS[
          state.unit as TemperatureUnit
        ] as string;
      });
